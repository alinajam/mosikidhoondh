...
def home():
  ...
  if request.method == "POST" and not "addbutton" in request.form:
    ...
    #commented out lines below were me trying to implement playlist display with audio player
    #client_id = '85725aa023e545729e6630b2a369cf90'
    #client_secret = '1abf0e31be774f2d9fb434adb538ae87'
    #spotify = spotipy.Spotify(auth_manager=SpotifyClientCredentials(client_id, client_secret))
    #relevanttrack = spotifyfunctions.get_track(songId)
    chosensongs.append(trackurl)
